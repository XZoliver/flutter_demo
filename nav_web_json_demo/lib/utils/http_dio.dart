...
class BaseHttpValues{
  //http://rap2api.taobao.org/app/mock/232744/example
  static const String BASE_URL = "http://192.168.43.126:8080/example";
}
...
class HttpUtil {
  ...
  HttpUtil() {
    ...
    options = new BaseOptions(
      //请求基地址,可以包含子路径
      baseUrl: BaseHttpValues.BASE_URL,
      //连接服务器超时时间，单位是毫秒.
